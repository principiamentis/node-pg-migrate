...
export const loadMigrationFiles = async (dir: string) => {
...
const resolveSuffix = async (directory: string, { language }: CreateOptionsDefault) =>
  language || (await getLastSuffix(directory)) || 'js'
